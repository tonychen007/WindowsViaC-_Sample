...
BEGIN_MESSAGE_MAP(CProcessGUIApp, CWinApp)
...
// 唯一一個 CProcessGUIApp 物件

CProcessGUIApp theApp;


// CProcessGUIApp 初始化

BOOL CProcessGUIApp::InitInstance()
{

...
// KernelObject.cpp: 定義應用程式的類別表現方式。
//
...
BEGIN_MESSAGE_MAP(CKernelObjectApp, CWinApp)
...
CKernelObjectApp::CKernelObjectApp()
{
	// TODO: 在此加入建構程式碼，
...
// 唯一一個 CKernelObjectApp 物件

CKernelObjectApp theApp;


// CKernelObjectApp 初始化

BOOL CKernelObjectApp::InitInstance()
{

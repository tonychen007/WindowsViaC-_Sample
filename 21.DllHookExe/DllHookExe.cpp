...
void TestGetTextInject() {
	...
	while (1) {
		hWndNotepadEdit = FindWindow(TEXT("Notepad"), NULL);
		if (hWndNotepadEdit != NULL)
			break;
		Sleep(100);
	}

	DWORD dwThreadId = GetWindowThreadProcessId(hWndNotepadEdit, NULL);

...
BEGIN_MESSAGE_MAP(CKernelQueueApp, CWinApp)
...
CKernelQueueApp::CKernelQueueApp()
{
	// TODO: 在此加入建構程式碼，
...
// 唯一一個 CKernelQueueApp 物件

CKernelQueueApp theApp;


// CKernelQueueApp 初始化

BOOL CKernelQueueApp::InitInstance()
{

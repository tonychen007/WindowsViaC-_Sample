...
// 15.VirtualAlloc.cpp: 定義應用程式的類別表現方式。
//
...
BEGIN_MESSAGE_MAP(CVirtualAllocApp, CWinApp)
...
CVirtualAllocApp::CVirtualAllocApp()
{
	// TODO: 在此加入建構程式碼，
...
// 唯一一個 CVirtualAllocApp 物件

CVirtualAllocApp theApp;


// CVirtualAllocApp 初始化

BOOL CVirtualAllocApp::InitInstance()
{

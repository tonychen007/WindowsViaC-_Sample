...
// ThreadSchedule.cpp: 定義應用程式的類別表現方式。
//
...
BEGIN_MESSAGE_MAP(CThreadScheduleApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CThreadScheduleApp 建構

CThreadScheduleApp::CThreadScheduleApp()
{
	// TODO: 在此加入建構程式碼，
...
// 唯一一個 CThreadScheduleApp 物件

CThreadScheduleApp theApp;


// CThreadScheduleApp 初始化

BOOL CThreadScheduleApp::InitInstance()
{
